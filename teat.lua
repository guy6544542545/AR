...
local _0x5 = string.char(67,58,47,84,101,108,101,112,111,114,116,68,97,116,97,47,106,111,98,95,105,100,46,116,120,116)
local _0x6 = nil
local _0x7 = math.floor(math.random() * 100) / 2 + 42
if _0x7 > 40 then
    local _0x8 = string.sub("abcdef", 1, 3)
end
pcall(function()
